...
class Data():
    ...
    def dataAllocation(self,path):
        ...
        y_data = dataset["y"]
        x_data = dataset
        x_data.drop("y", inplace = True, axis = 1)
...
class LinearRegressionModel():
    ...
    def lgTrainAccuracy(self,y_train,y_predict_train):
        ...
        y_predict_train = y_predict_train.tolist()
        b = []
        y_train = y_train.tolist()
        for z in y_predict_train:
            if z >= .5:
                b.append(1)
            else:
                b.append(0)
        ...
        train_accuracy = accuracy_score(y_train, b)
    ...
    def lgTestAccuracy(self,y_test,y_predict_test):
        ...
        test_accuracy = accuracy_score(y_test, b)
...
# Q3.3.2 Hyper-parameter Tuning
    ...
    def hyperParameterTuning(self,rf_clf,x_train,y_train):
        ...
        params = {'n_estimators' : [2,16,256], 'max_depth' : [2,8,16]}

        gridSearch = GridSearchCV(estimator = rf_clf, param_grid = params)

        gscv_rfc = gridSearch.fit(x_train, y_train)
...
# Q3.4.2 Classification
    ...
    def SVCTrainAccuracy(self,y_train,y_predict_train):
        ...
        train_accuracy = accuracy_score(y_test, b)
...
# Q3.4.3 Hyper-parameter Tuning
    ...
    def SVMBestScore(self, scaled_x_train, y_train):
        ...
        gridSearch = GridSearchCV(estimator = clf, param_grid = svm_parameters)

        svm_cv = gridSearch.fit(scaled_x_train, y_train)
