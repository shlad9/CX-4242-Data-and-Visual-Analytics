...
def author():
        return "slad8" # replace gburdell3 with your Georgia Tech username.

def gtid():
    return 903279724 # replace with your GT ID number
...
class PageRank:
    ...
    def run_pagerank(self, node_weights,  damping_factor=0.85, iterations=10):
        ...
        #############################################
            ...
            factor = np.array(new_pr_values)
            pr_values = ((1-damping_factor) * (node_weights) + (damping_factor * factor))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="sample command: python pagerank.py -i 10 -d 0.85 personalized_pagerank network.tsv")
